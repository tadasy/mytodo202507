...
func (c *todoServiceClient) ListTodos(ctx context.Context, in *ListTodosRequest, opts ...grpc.CallOption) (*ListTodosResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.TodoService/ListTodos", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) MarkTodoComplete(ctx context.Context, in *MarkTodoCompleteRequest, opts ...grpc.CallOption) (*MarkTodoCompleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.TodoService/MarkTodoComplete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) ListCompletedTodos(ctx context.Context, in *ListCompletedTodosRequest, opts ...grpc.CallOption) (*ListCompletedTodosResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/proto.TodoService/ListCompletedTodos", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TodoService_ListTodos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.TodoService/ListTodos",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TodoService_MarkTodoComplete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.TodoService/MarkTodoComplete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TodoService_ListCompletedTodos_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.TodoService/ListCompletedTodos",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
