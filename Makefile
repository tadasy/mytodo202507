...
proto:
	...
	protoc --go_out=proto --go_opt=module=github.com/tadasy/mytodo202507/proto --go-grpc_out=proto --go-grpc_opt=module=github.com/tadasy/mytodo202507/proto proto/*.proto
